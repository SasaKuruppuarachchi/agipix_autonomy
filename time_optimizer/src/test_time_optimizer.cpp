...
int main(int argc, char**argv){
	...
	auto node = std::make_shared<rclcpp::Node>("test_time_optimizer_node");
	(void)node;
	...
	rclcpp::Time startTime = rclcpp::Clock(RCL_STEADY_TIME).now();
	...
	rclcpp::Time endTime = rclcpp::Clock(RCL_STEADY_TIME).now();
