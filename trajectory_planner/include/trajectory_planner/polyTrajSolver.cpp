...
namespace trajPlanner{
	...
	void polyTrajSolver::updateInitVel(const geometry_msgs::msg::Twist& v){
		this->initVel_ = v;
	}
	...
	void polyTrajSolver::updateEndVel(const geometry_msgs::msg::Twist& v){
		this->endVel_ = v;
	}
	...
	void polyTrajSolver::updateInitAcc(const geometry_msgs::msg::Twist& a){
		this->initAcc_ = a;
	}
	...
	void polyTrajSolver::updateEndAcc(const geometry_msgs::msg::Twist& a){
		this->endAcc_ = a;
	}
