...
namespace globalPlanner{
	...
	private:
		...
		rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr roadmapPub_;
		rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr candidatePathPub_;
		rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr bestPathPub_;
		rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr frontierVisPub_;
	...
	public:
		DEP(const rclcpp::Node::SharedPtr &node);
